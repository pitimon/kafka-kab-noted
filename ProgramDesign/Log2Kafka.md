...
---
### ระบบ Kafka Producer by Go 

คำอธิบาย:
ระบบ Kafka Producer นี้เป็นโปรแกรมที่เขียนด้วยภาษา Go ออกแบบมาเพื่ออ่านข้อมูลจากไฟล์ log และส่งข้อมูลไปยัง Kafka cluster แบบ asynchronous โดยมีการจัดการการเชื่อมต่อแบบ SASL/SSL และรองรับการทำงานแบบ concurrent เพื่อเพิ่มประสิทธิภาพในการประมวลผลไฟล์ขนาดใหญ่
